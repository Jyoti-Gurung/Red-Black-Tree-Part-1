...
//Fix Violations After Insertion: we call the rotateRight & rotateLeft Functions here
...
int main(){
  ...
  char action;
  cout << endl<< "WARNING: NO DUPLICATS OTHER WISE YOU WILL GET ERROR!" << endl;
  
  while (true) {
    
    cout << endl << "Type A to Insert, B to Print, C to Insert File & Print" << endl;
    cin >> action;
